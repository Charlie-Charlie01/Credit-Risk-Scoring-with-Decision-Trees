...
Instead of relying solely on a human loan officer's judgment, ML models analyze historical borrower data to automatically assign a risk score or classification — typically:

✅ Low Risk → Loan approved
⚠️ Medium Risk → Conditional approval / higher interest rate
